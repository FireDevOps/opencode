export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub መጫን አልቻለም",
  "desktop.recovery.terminated": "[AoG] Hub መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "[AoG] Hub ምላሽ እየሰጠ አይደለም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) [AoG] Hub WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ [AoG] Hub።",
  ...
  "help.tabs.introduction": "[AoG] Hub ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ [AoG] Hub እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "[AoG] Hub ዴስክቶፕ",
  ...
  "settings.general.row.colorScheme.description": "[AoG] Hub ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "[AoG] Hub ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "[AoG] Hub ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
