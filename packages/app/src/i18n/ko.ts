export const dict = {
  ...
  "settings.general.row.language.description": "[AoG] Hub 표시 언어 변경",
  ...
  "settings.general.row.theme.description": "[AoG] Hub 테마 사용자 지정",
  ...
  "help.tabs.introduction": "이제 [AoG] Hub Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.terminated": "[AoG] Hub 윈도우가 예기치 않게 종료되었습니다",
