...
export const dict = {
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en [AoG] Hub getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan [AoG] Hub aftur.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af [AoG] Hub ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, [AoG] Hub styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "[AoG] Hub skjáborð",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig [AoG] Hub lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort [AoG] Hub fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig [AoG] Hub er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar [AoG] Hub ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af [AoG] Hub.",
