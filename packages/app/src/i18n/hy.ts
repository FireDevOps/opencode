export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub մենյու",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "[AoG] Hub պատուհանն անսպասելիորեն ավարտվեց",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք [AoG] Hub։",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է [AoG] Hub տեսքը ձեր սարքում",
