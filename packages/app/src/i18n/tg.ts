export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Ҳуҷҷатҳо",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub бор карда натавонист",
  "desktop.recovery.terminated": "[AoG] Hub тиреза ба таври ғайричашмдошт қатъ карда шуд",
  "desktop.recovery.unresponsive": "[AoG] Hub ҷавоб намедиҳад",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) лозим аст, то [AoG] Hub сервери WSL илова карда шавад",
  "wsl.onboarding.wslUnavailable.title": "WSL дастрас нест",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub WSL-ро дар ин мошин тафтиш карда натавонист.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop ҳоло дар атрофи ҷадвалҳо сохта шудааст.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Версияи нави [AoG] Hub ({{version}}) ҳоло барои насб дастрас аст.",
  ...
  "error.chain.mcpFailed":
    'MCP сервери "{{name}}" ноком шуд. Дар хотир доред, ки [AoG] Hub тасдиқи MCP-ро ҳанӯз дастгирӣ намекунад.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub моделҳои ройгонро дар бар мегирад, то шумо метавонед фавран оғоз кунед.",
  ...
  "settings.general.row.language.description": "Забони намоишро барои [AoG] Hub иваз кунед",
  ...
  "settings.general.row.appearance.description":
    "Фармоиш диҳед, ки чӣ гуна [AoG] Hub дар дастгоҳи шумо намуди зоҳирӣ дорад",
  "settings.general.row.colorScheme.title": "Схемаи ранг",
  "settings.general.row.colorScheme.description":
    "Интихоб кунед, ки [AoG] Hub аз рӯи система, равшанӣ ё мавзӯи торик пайравӣ мекунад",
  "settings.general.row.theme.title": "Мавзӯъ",
  "settings.general.row.theme.description": "Чӣ тавр [AoG] Hub мавзӯъро танзим кунед.",
  ...
  "settings.updates.row.startup.description": "Ҳангоми оғоз кардани [AoG] Hub навсозиҳо ба таври худкор санҷед",
