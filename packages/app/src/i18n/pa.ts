export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub دیاں دستاویزاں",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub مینو",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "[AoG] Hub دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "[AoG] Hub جواب نئیں دے رہیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "[AoG] Hub دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر [AoG] Hub دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "[AoG] Hub ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، [AoG] Hub ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "app.name.desktop": "[AoG] Hub ڈیسک ٹاپ",
  ...
  "settings.general.row.language.description": "[AoG] Hub لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے [AoG] Hub کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا [AoG] Hub سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "[AoG] Hub نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں [AoG] Hub لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی [AoG] Hub دا تازہ ترین ورژن چلا رئے او۔",
