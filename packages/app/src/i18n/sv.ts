export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub kunde inte läsas in",
  "desktop.recovery.terminated": "OpenCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "[AoG] Hub svarar inte",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan [AoG] Hub kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan [AoG] Hub igen.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av [AoG] Hub ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, [AoG] Hub stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Anpassa hur [AoG] Hub ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om [AoG] Hub följer system-, ljus- eller mörktemat",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när [AoG] Hub startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av [AoG] Hub.",
