export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de [AoG] Hub",
  ...
  "desktop.menu.ariaLabel": "Menú de [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar [AoG] Hub",
  "desktop.recovery.terminated": "La ventana de [AoG] Hub se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "[AoG] Hub no responde",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que [AoG] Hub pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de [AoG] Hub ({{version}}) está disponible para instalar.",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: [AoG] Hub aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve [AoG] Hub en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si [AoG] Hub sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de [AoG] Hub.",
