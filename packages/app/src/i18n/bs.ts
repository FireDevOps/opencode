export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor OpenCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "[AoG] Hub ne reaguje",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi [AoG] Hub mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: [AoG] Hub još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako [AoG] Hub izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li [AoG] Hub prati sistemsku, svijetlu ili tamnu temu",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se [AoG] Hub pokrene",
