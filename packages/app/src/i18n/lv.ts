export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub dokumentācija",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt [AoG] Hub",
  "desktop.recovery.terminated": "[AoG] Hub logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "[AoG] Hub neatbild",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms [AoG] Hub var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet [AoG] Hub no jauna.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna [AoG] Hub versija ({{version}}) instalēšanai.",
  ...
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, [AoG] Hub vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "[AoG] Hub darbvirsma",
  ...
  "settings.general.row.language.description": "Mainīt [AoG] Hub saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā [AoG] Hub izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai [AoG] Hub sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet [AoG] Hub tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko [AoG] Hub versiju.",
