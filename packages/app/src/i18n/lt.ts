...
export const dict = {
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad [AoG] Hub galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują [AoG] Hub ({{version}}) versiją.",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad [AoG] Hub dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "[AoG] Hub darbalaukis",
  ...
  "settings.general.row.language.description": "Pakeiskite [AoG] Hub ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip [AoG] Hub atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar [AoG] Hub seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite [AoG] Hub temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią [AoG] Hub versiją.",
