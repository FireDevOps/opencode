...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub 載入失敗",
  "desktop.recovery.terminated": "[AoG] Hub 視窗意外終止",
  "desktop.recovery.unresponsive": "[AoG] Hub 沒有回應",
  ...
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 [AoG] Hub。",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "[AoG] Hub 有新版本 ({{version}}) 可安裝。",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：[AoG] Hub 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 [AoG] Hub 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 [AoG] Hub 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 [AoG] Hub 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 [AoG] Hub 的主題。",
  ...
  "settings.updates.row.startup.description": "在 [AoG] Hub 啟動時自動檢查更新",
