...
export const dict = {
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor [AoG] Hub einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann [AoG] Hub erneut.",
  ...
  "toast.update.description": "Eine neue Version von [AoG] Hub ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: [AoG] Hub unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "[AoG] Hub mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für [AoG] Hub ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie [AoG] Hub auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob [AoG] Hub dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von [AoG] Hub anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von [AoG] Hub automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "[AoG] Hub ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von [AoG] Hub wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das OpenCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "[AoG] Hub reagiert nicht",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
