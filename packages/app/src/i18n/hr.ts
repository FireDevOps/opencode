...
export const dict = {
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što [AoG] Hub može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite [AoG] Hub.",
  ...
  "help.tabs.introduction": "Radna površina [AoG] Hub sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija [AoG] Hub ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, [AoG] Hub još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "[AoG] Hub Radna površina",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako [AoG] Hub izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li [AoG] Hub slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je [AoG] Hub tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se [AoG] Hub pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju [AoG] Hub.",
