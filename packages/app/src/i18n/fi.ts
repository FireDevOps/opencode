export const dict = {
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin [AoG] Hub voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten [AoG] Hub uudelleen.",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että [AoG] Hub ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä [AoG] Hub näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö [AoG] Hub järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun [AoG] Hub käynnistyy",
  ...
  "desktop.recovery.unresponsive": "[AoG] Hub ei vastaa",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
