export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap [AoG] Hub ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "[AoG] Hub tidak memberi respons",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum [AoG] Hub boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu [AoG] Hub ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, [AoG] Hub belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa [AoG] Hub pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada [AoG] Hub mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila [AoG] Hub dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini [AoG] Hub.",
