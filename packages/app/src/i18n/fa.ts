export const dict = {
  ...
  "desktop.menu.documentation": "مستندات [AoG] Hub",
  ...
  "desktop.menu.ariaLabel": "منوی [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub بارگیری نشد",
  "desktop.recovery.terminated": "پنجره [AoG] Hub به طور غیرمنتظره ای خاتمه یافت",
  "desktop.recovery.unresponsive": "[AoG] Hub پاسخ نمی دهد",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (زیر سیستم Windows برای Linux) قبل از اینکه [AoG] Hub بتواند یک سرور WSL اضافه کند لازم است",
  "wsl.onboarding.wslUnavailable.title": "WSL در دسترس نیست",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub نتوانست WSL را در این دستگاه تأیید کند.",
  "wsl.onboarding.installWsl": "WSL را نصب کنید",
  "wsl.onboarding.windowsRestartRequired":
    "Windows را مجددا راه اندازی کنید تا نصب WSL به پایان برسد، سپس [AoG] Hub را دوباره باز کنید.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop اکنون در اطراف زبانه ها ساخته شده است.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "نسخه جدیدی از [AoG] Hub ({{version}}) اکنون برای نصب در دسترس است.",
  ...
  "error.chain.mcpFailed":
    'سرور MCP "{{name}}" ناموفق بود. توجه داشته باشید، [AoG] Hub هنوز از احراز هویت MCP پشتیبانی نمی کند.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub شامل مدل های رایگان است، بنابراین می توانید بلافاصله شروع کنید.",
  ...
  "settings.general.row.language.description": "زبان نمایش را برای [AoG] Hub تغییر دهید",
  ...
  "settings.general.row.appearance.description": "نحوه ظاهر [AoG] Hub را در دستگاه خود سفارشی کنید",
  "settings.general.row.colorScheme.title": "طرح رنگ",
  "settings.general.row.colorScheme.description": "انتخاب کنید که آیا [AoG] Hub از تم سیستمی، روشن یا تیره پیروی می کند",
  "settings.general.row.theme.title": "موضوع",
  "settings.general.row.theme.description": "نحوه مضمون سازی [AoG] Hub را سفارشی کنید.",
  ...
  "settings.updates.row.startup.description": "هنگام راه‌اندازی [AoG] Hub، به‌روزرسانی‌ها را به‌طور خودکار بررسی کنید",
  ...
  "settings.updates.toast.latest.description": "شما آخرین نسخه [AoG] Hub را اجرا می کنید.",
