...
export const dict = {
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a [AoG] Hub hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A [AoG] Hub nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a [AoG] Hub programot.",
  ...
  "help.tabs.introduction": "A [AoG] Hub Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A [AoG] Hub ({{version}}) új verziója már telepíthető.",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a [AoG] Hub még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A [AoG] Hub ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "[AoG] Hub asztali számítógép",
  ...
  "settings.general.row.language.description": "Módosítsa a [AoG] Hub kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a [AoG] Hub az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a [AoG] Hub a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a [AoG] Hub témáját.",
  ...
  "settings.updates.row.startup.description": "A [AoG] Hub indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a [AoG] Hub legújabb verzióját futtatja.",
