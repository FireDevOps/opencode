export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub kan niet worden geladen",
  "desktop.recovery.terminated": "Het OpenCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "[AoG] Hub reageert niet",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat [AoG] Hub een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens [AoG] Hub opnieuw.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van [AoG] Hub ({{version}}) beschikbaar om te installeren.",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: [AoG] Hub ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe [AoG] Hub eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of [AoG] Hub het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van [AoG] Hub aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer [AoG] Hub wordt gestart",
  ...
  "settings.updates.toast.latest.title": "[AoG] Hub is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van [AoG] Hub.",
