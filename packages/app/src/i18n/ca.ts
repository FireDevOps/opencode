export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Documentació",
  ...
  "desktop.menu.ariaLabel": "menú [AoG] Hub.",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra [AoG] Hub s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "[AoG] Hub no respon",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que [AoG] Hub pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de [AoG] Hub ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que [AoG] Hub encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "[AoG] Hub Escriptori",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu [AoG] Hub al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si [AoG] Hub segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de [AoG] Hub.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï [AoG] Hub.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de [AoG] Hub.",
