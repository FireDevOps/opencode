export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do [AoG] Hub",
  ...
  "desktop.menu.ariaLabel": "Menu do [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o [AoG] Hub",
  "desktop.recovery.terminated": "A janela do [AoG] Hub foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O [AoG] Hub não está respondendo",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o [AoG] Hub possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O [AoG] Hub não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o [AoG] Hub novamente.",
  ...
  "help.tabs.introduction": "Agora, o [AoG] Hub Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do [AoG] Hub ({{version}}) está disponível para instalação.",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: [AoG] Hub ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Personalize como o [AoG] Hub aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o [AoG] Hub segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o [AoG] Hub é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o [AoG] Hub iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do [AoG] Hub.",
