export const dict = {
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che [AoG] Hub possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di [AoG] Hub ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: [AoG] Hub non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di [AoG] Hub sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se [AoG] Hub segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di [AoG] Hub",
  ...
  "settings.updates.toast.latest.title": "[AoG] Hub è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di [AoG] Hub.",
  ...
  "desktop.menu.documentation": "Documentazione di [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare [AoG] Hub",
  "desktop.recovery.terminated": "La finestra di [AoG] Hub si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "[AoG] Hub non risponde",
