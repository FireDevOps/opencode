export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub se nepodařilo načíst",
  "desktop.recovery.terminated": "[AoG] Hub okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "[AoG] Hub nereaguje",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než [AoG] Hub může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze [AoG] Hub ({{version}}).",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: [AoG] Hub zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled [AoG] Hub na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude [AoG] Hub následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi [AoG] Hub.",
