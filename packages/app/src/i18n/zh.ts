...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub 加载失败",
  "desktop.recovery.terminated": "[AoG] Hub 窗口意外终止",
  "desktop.recovery.unresponsive": "[AoG] Hub 未响应",
  ...
  "wsl.onboarding.wslNotInstalled.description": "[AoG] Hub 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 [AoG] Hub。",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "[AoG] Hub 有新版本 ({{version}}) 可安装。",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：[AoG] Hub 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 [AoG] Hub 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 [AoG] Hub 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 [AoG] Hub 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 [AoG] Hub 的主题。",
  ...
  "settings.updates.row.startup.description": "在 [AoG] Hub 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 [AoG] Hub。",
