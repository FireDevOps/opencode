export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub meni",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno [AoG] Hub se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "[AoG] Hub se ne odziva",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko [AoG] Hub doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica [AoG] Hub ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, [AoG] Hub še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako [AoG] Hub izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali [AoG] Hub sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico [AoG] Hub.",
