export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać [AoG] Hub",
  "desktop.recovery.terminated": "Okno [AoG] Hub zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "[AoG] Hub nie odpowiada",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim [AoG] Hub będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja [AoG] Hub ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: [AoG] Hub nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd [AoG] Hub na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy [AoG] Hub ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji [AoG] Hub.",
