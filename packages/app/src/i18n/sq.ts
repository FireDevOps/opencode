export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni [AoG] Hub",
  ...
  "desktop.menu.ariaLabel": "Menuja [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja [AoG] Hub u mbyll papritur",
  "desktop.recovery.unresponsive": "[AoG] Hub nuk po përgjigjet",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se [AoG] Hub të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i [AoG] Hub ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, [AoG] Hub nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket [AoG] Hub në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse [AoG] Hub ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të [AoG] Hub.",
