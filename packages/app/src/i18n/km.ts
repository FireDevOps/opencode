export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ [AoG] Hub",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច [AoG] Hub ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "[AoG] Hub មិនឆ្លើយតបទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល [AoG] Hub អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក [AoG] Hub ឡើងវិញ។",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "toast.update.description": "កំណែថ្មីនៃ [AoG] Hub ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ [AoG] Hub មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល [AoG] Hub មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ [AoG] Hub ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល [AoG] Hub មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល [AoG] Hub ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ [AoG] Hub ។",
