export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub hujjatlari",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub menyusi",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub yuklanmadi",
  "desktop.recovery.terminated": "[AoG] Hub oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "[AoG] Hub javob bermayapti",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "[AoG] Hub WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub WSL ni ushbu mashinada tasdiqlay olmadi.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "[AoG] Hub ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, [AoG] Hub hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "[AoG] Hub bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.general.row.language.description": "[AoG] Hub uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "[AoG] Hub qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "[AoG] Hub tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "[AoG] Hub mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "[AoG] Hub ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz [AoG] Hub oxirgi versiyasini ishga tushiryapsiz.",
