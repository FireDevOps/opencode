export const dict = {
  ...
  "desktop.menu.documentation": "Documentație [AoG] Hub",
  ...
  "desktop.menu.ariaLabel": "Meniu [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra [AoG] Hub s-a închis neașteptat",
  "desktop.recovery.unresponsive": "[AoG] Hub nu răspunde",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca [AoG] Hub să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune [AoG] Hub ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, [AoG] Hub nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub include modele gratuite ca să poți începe imediat.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul [AoG] Hub pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă [AoG] Hub urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune [AoG] Hub.",
