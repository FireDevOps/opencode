export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Skjøl",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub valmynd",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub miseydnaðist at heinta",
  "desktop.recovery.terminated": "[AoG] Hub vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "[AoG] Hub svarar ikki",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn [AoG] Hub kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani [AoG] Hub aftur.",
  ...
  "help.tabs.introduction": "[AoG] Hub Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av [AoG] Hub ({{version}}) er nú tøk at seta upp.",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, [AoG] Hub stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "[AoG] Hub Skrivaraborð",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu [AoG] Hub sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um [AoG] Hub fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu [AoG] Hub er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá [AoG] Hub byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av [AoG] Hub.",
