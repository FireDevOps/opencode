export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Resminamalar",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub menýusy",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub ýükläp bilmedi",
  "desktop.recovery.terminated": "[AoG] Hub penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "[AoG] Hub jogap berenok",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) [AoG] Hub WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra [AoG] Hub açyň.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin [AoG] Hub ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, [AoG] Hub entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.general.row.language.description": "[AoG] Hub üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "[AoG] Hub enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "[AoG] Hub ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  ...
  "settings.updates.row.startup.description": "[AoG] Hub işe başlanda täzelenmeleri awtomatiki barlaň",
