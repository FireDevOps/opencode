export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu [AoG] Hub",
  ...
  "desktop.recovery.loadFailed": "Không tải được [AoG] Hub",
  "desktop.recovery.terminated": "Cửa sổ [AoG] Hub đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "[AoG] Hub không phản hồi",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi [AoG] Hub có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của [AoG] Hub ({{version}}) để cài đặt.",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: [AoG] Hub chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của [AoG] Hub trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem [AoG] Hub tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi [AoG] Hub khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của [AoG] Hub.",
