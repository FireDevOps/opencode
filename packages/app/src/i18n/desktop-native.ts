...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub failed to load",
  "desktop.recovery.terminated": "[AoG] Hub window terminated unexpectedly",
  "desktop.recovery.unresponsive": "[AoG] Hub is not responding",
