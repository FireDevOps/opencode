export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub laadimine ebaõnnestus",
  "desktop.recovery.terminated": "[AoG] Hub aken suleti ootamatult",
  "desktop.recovery.unresponsive": "[AoG] Hub ei vasta",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui [AoG] Hub saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse [AoG] Hub ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, [AoG] Hub ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "[AoG] Hub Töölaud",
  ...
  "settings.general.row.language.description": "Muutke [AoG] Hub kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas [AoG] Hub teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas [AoG] Hub järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas [AoG] Hub on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui [AoG] Hub käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse [AoG] Hub uusimat versiooni.",
