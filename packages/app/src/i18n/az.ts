export const dict = {
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub yüklənə bilmədi",
  "desktop.recovery.terminated": "[AoG] Hub pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "[AoG] Hub cavab vermir",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "[AoG] Hub WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub bu maşında WSL-i doğrulaya bilmədi.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: [AoG] Hub hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "settings.general.row.language.description": "[AoG] Hub üçün ekran dilini dəyişdirin",
  ...
  "settings.updates.row.startup.description": "[AoG] Hub açıldıqda avtomatik yeniləmələri yoxla",
