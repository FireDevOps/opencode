export const dict = {
  ...
  "desktop.menu.documentation": "[AoG] Hub Документация",
  ...
  "desktop.menu.ariaLabel": "[AoG] Hub меню",
  ...
  "desktop.recovery.loadFailed": "[AoG] Hub не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът [AoG] Hub приключи неочаквано",
  "desktop.recovery.unresponsive": "[AoG] Hub не отговаря",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди [AoG] Hub да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "[AoG] Hub не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново [AoG] Hub.",
  ...
  "help.tabs.introduction": "[AoG] Hub Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на [AoG] Hub ({{version}}).",
  ...
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че [AoG] Hub все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "[AoG] Hub включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда [AoG] Hub на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали [AoG] Hub следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на [AoG] Hub.",
