export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل [AoG] Hub",
  "desktop.recovery.terminated": "توقفت نافذة [AoG] Hub بشكل غير متوقع",
  "desktop.recovery.unresponsive": "[AoG] Hub لا يستجيب",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن [AoG] Hub من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على [AoG] Hub التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح [AoG] Hub.",
  ...
  "help.tabs.introduction": "أصبح [AoG] Hub Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من [AoG] Hub ({{version}}) للتثبيت.",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن [AoG] Hub لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن [AoG] Hub نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ [AoG] Hub",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور [AoG] Hub على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان [AoG] Hub يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة [AoG] Hub.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل [AoG] Hub",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من [AoG] Hub.",
