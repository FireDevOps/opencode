export const dict = {
  ...
  "desktop.updater.none.message": "Χρησιμοποιείτε ήδη την πιο πρόσφατη έκδοση του [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Έχει γίνει λήψη της έκδοσης {{version}} του [AoG] Hub. Θέλετε να την εγκαταστήσετε και να επανεκκινήσετε την εφαρμογή;",
