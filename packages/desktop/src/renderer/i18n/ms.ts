export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} [AoG] Hub telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
