export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de [AoG] Hub. ¿Quieres instalarla y reiniciar?",
