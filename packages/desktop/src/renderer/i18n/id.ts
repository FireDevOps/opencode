export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "[AoG] Hub versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
