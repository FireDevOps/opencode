export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van [AoG] Hub is gedownload. Wil je deze installeren en [AoG] Hub opnieuw starten?",
