export const dict = {
  ...
  "desktop.updater.none.message": "Már az [AoG] Hub legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az [AoG] Hub {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
