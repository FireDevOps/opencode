export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} [AoG] Hub je bila prenesena, jo želite namestiti in znova zagnati?",
