export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of [AoG] Hub has been downloaded, would you like to install it and relaunch?",
