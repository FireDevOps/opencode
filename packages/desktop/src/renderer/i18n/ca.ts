export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'[AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'[AoG] Hub. Voleu instal·lar-la i reiniciar l'aplicació?",
