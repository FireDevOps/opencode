export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von [AoG] Hub wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
