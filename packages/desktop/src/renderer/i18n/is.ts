export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af [AoG] Hub hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
