export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'[AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'[AoG] Hub a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
