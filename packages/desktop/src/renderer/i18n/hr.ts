export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije [AoG] Hub. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
