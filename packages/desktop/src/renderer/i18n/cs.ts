export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace [AoG] Hub. Chcete ji nainstalovat a aplikaci znovu spustit?",
