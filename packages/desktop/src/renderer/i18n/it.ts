export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di [AoG] Hub è stata scaricata. Vuoi installarla e riavviare l'app?",
