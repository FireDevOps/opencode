export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av [AoG] Hub.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av [AoG] Hub er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
