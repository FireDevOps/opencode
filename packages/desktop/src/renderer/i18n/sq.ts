export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i [AoG] Hub është shkarkuar, dëshironi ta instaloni dhe rinisni?",
