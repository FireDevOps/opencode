export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av [AoG] Hub har laddats ned. Vill du installera den och starta om programmet?",
