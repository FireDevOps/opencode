export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do [AoG] Hub foi baixada. Você gostaria de instalá-la e reiniciar?",
