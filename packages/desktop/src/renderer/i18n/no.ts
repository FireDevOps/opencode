export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av [AoG] Hub er lastet ned. Vil du installere den og starte på nytt?",
