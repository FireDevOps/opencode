export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse [AoG] Hub uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "[AoG] Hub'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
