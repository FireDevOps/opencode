export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه [AoG] Hub استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} [AoG] Hub دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
