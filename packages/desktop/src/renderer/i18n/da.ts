export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af [AoG] Hub er blevet downloadet. Vil du installere den og genstarte?",
