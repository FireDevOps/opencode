export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko [AoG] Hub versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "[AoG] Hub versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
