export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на [AoG] Hub",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от [AoG] Hub е изтеглена. Искате ли да я инсталирате и рестартирате?",
